            ...
            if "?" in words[i]:
                ...
                if "?" in word_next:
                    ...
                    if "?" in word_next_next:
                        ...
                        next_index = 3
                    else: #no question mark on the question
                        print("No question mark on the question...they screwed us!!")
                        return
                        
        #print(question)
        prize_q = 0
        if "Prize for" in words[i+next_index] or "this question" in words[i+next_index]:
            prize_q = 1
        answer1 = words[i+next_index+prize_q]
        answer2 = words[i+next_index+prize_q+1]
        answer3 = words[i+next_index+prize_q+2]
        #print(answer1)
        #print(answer2)
        #print(answer3)
...
#file_path = "cs7.png"
#question, answer1, answer2, answer3 = detect_text(file_path) #This collects the image text using google vision api
